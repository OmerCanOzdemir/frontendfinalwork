                                ...
                                <table className="min-w-full divide-y divide-gray-200 table-fixed">
                                    ...
                                    <tbody className="bg-slate-100 divide-y divide-gray-200">
                                        ...
                                        {data.educations.map((education) => (
                                            ...
                                            <tr className="h-10  hover:bg-gray-200" key={education.id}>
                                                <td className="py-4 px-6 text-sm font-medium  whitespace-nowrap">{education.id}</td>
                                                <td className="py-4 px-6 text-sm font-medium  whitespace-nowrap">{education.name}</td>
                                                <td className="py-4 px-6 text-sm font-medium  whitespace-nowrap">{education.department_Address}</td>
                                                <td className="py-4 px-6 text-sm font-medium  whitespace-nowrap"><button onClick={() => push_to_edit_page("/education/edit/" + education.id)} className="bg-yellow-400 hover:bg-yellow-500 text-white font-bold py-2 px-4 rounded"><svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z" /></svg></button></td>
                                            </tr>
                                        ))}
                                    </tbody>
                                </table>
